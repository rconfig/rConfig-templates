...
Covers Netgear M Series managed switches, principally the M4300 and M4500.

| Template | Use for |
| --- | --- |
| `netgear-mseries-ssh-enable.yml` | M Series devices where the account needs enable mode |
